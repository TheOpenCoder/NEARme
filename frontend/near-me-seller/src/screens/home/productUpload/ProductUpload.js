        ...
        >
            <View style={{ flexDirection: "row", height: 140, marginHorizontal: 10, marginBottom: 20, backgroundColor: "#F5F5F5", padding: 10, borderRadius: 10 }}>
                <View style={{ flex: 1.2, marginRight: 10, position: "relative" }}>
                    {image ? <Image source={{ uri: image }} style={styles.image} /> : <Image source={require('../../../../assets/images/image-placeholder.png')} style={styles.image} />}
                </View>
                <View style={{ flex: 2 }}>
                    <Pressable style={{ flex: 2, paddingTop: 4 }}>
                        <Text numberOfLines={2} style={{ fontFamily: "MontserratMedium", fontSize: 16 }}>{productName ? productName : "Product Name"}</Text>
                        <Text numberOfLines={1} style={{ color: "#464A29" }}>{category ? category : "Product category"}</Text>
                    </Pressable>
                    <View style={{ flex: 1.5, flexDirection: "row" }}>
                        <View style={{ flex: 1, justifyContent: "center" }}>
                            <Text style={{ fontFamily: "MontserratSemiBold", fontSize: 20 }}>₹{price ? price : "Price"}</Text>
                        </View>
                    </View>
                </View>
            </View>
